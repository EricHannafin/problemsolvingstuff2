...
//ComputerData.java
/*This program processes the details of an arbitrary number of computers and has a user-defined method
 * to determine the average hard-disk space. It also validates the hard-disk space value*/
